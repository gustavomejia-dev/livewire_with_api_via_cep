      ...
      <div class = "h-0 w-0" x-show="open" @click.outside="open = false">
            <div class="justify-between mt-6">
                <nav class="bg-blue-100 w-40">
                    <a href = {{ route('ticket') }}class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">

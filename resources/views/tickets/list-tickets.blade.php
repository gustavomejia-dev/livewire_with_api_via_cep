...
<body x-data = "{'showModal' : false }" @keydown.escape="showModal = false">
    <div> 
        <x-sidebar/> 
    </div>

    <section class="flex-row h-screen justify-center items-center">
        @foreach ($tickets as $ticket)
        {{-- aqui está carregando os chamados com um link para mandar para uma modal referente ao ticket --}}
        
            
            <div class= "cursor-pointer" onclick = openModal({{$ticket->id}})>
